...
exports.controllerGetImgProductSendMutiImg = void 0;
const { Storage } = require('@google-cloud/storage');
const storage = new Storage();
const BUCKET = "tour_images";
const controllerGetImgProductSendMutiImg = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.controllerGetImgProductSendMutiImg = controllerGetImgProductSendMutiImg;
